...
add_action( 'jet-woo-builder/blank-page/after-content', 'jet_woo_zerif_close_site_main_wrap', 999 );
add_action( 'jet-woo-builder/full-width-page/after-content', 'jet_woo_zerif_close_site_main_wrap', 999 );
...
/**
 * Enqueue Zerif theme integration stylesheets.
 *
 * @return void
 * @since  1.0.0
 * @access public
