...
add_action( 'jet-woo-builder/blank-page/after-content', 'jet_woo_twenty_fifteen_close_site_main_wrap', 999 );
add_action( 'jet-woo-builder/full-width-page/after-content', 'jet_woo_twenty_fifteen_close_site_main_wrap', 999 );
