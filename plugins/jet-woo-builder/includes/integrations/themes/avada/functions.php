...
add_action( 'jet-woo-builder/blank-page/after-content', 'jet_woo_avada_close_site_main_wrap', 999 );
add_action( 'jet-woo-builder/full-width-page/after-content', 'jet_woo_avada_close_site_main_wrap', 999 );
...
/**
 * Fix WooCommerce hooks for Avada theme
 *
 * @return void
 */
...
/**
 * Enqueue Avada theme integration stylesheets.
 *
 * @return void
 * @since  1.0.0
 * @access public
