...
define( 'PIOTNETFORMS_PRO_VERSION', '1.1.19' );
...
//        }
				...
				function piotnetformsAddressAutocompleteInitMap() {
				    ...
				    inputs.forEach(function(el, index, array){
				        ...
				        autocomplete.addListener('place_changed', function() {
				          ...
				          if (jQuery(el).attr('data-piotnetforms-address-autocomplete') != undefined) {
                            jQuery(el).change();
                          }
	...
	public function piotnet_base_settings() {
        ...
        register_setting( 'piotnetforms-hubspot-group', 'piotnetforms-hubspot-api-key' );
