	...
	public function render() {
		...
		?>	
			<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
				<a class="piotnetforms-lost-password__url" href="<?php echo wp_lostpassword_url( get_permalink() ); ?>" title="<?php echo $settings['lost_password_text']; ?>"><?php echo $settings['lost_password_text']; ?></a>
			</div>
        <?php
		}
	}
		...
		%>
			<div <%= view.render_attributes('wrapper') %>>
				<% if ( s['lost_password_text'] ) { %>
					<a class="piotnetforms-lost-password__url" href="<?php echo wp_lostpassword_url( get_permalink() ); ?>" title="<%= s['lost_password_text'] %>"><%= s['lost_password_text'] %></a>
				<% } %>
			</div>
		<?php
	}
