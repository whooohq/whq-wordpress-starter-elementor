...
class Piotnetforms_Helper{
    ...
    public function piotnetforms_sendinblue_get_list($api_key){
        $curl = curl_init();
        curl_setopt_array($curl, array(
    ...
    public function piotnetforms_sendinblue_get_attribute($api_key){
        $curl = curl_init();
        curl_setopt_array($curl, array(
    ...
    public function piotnetforms_sendinblue_create_contact($api_key, $data){
        $curl = curl_init();
        curl_setopt_array($curl, array(
	...
	public function piotnetforms_convertkit_add_subscriber($data, $form_id){
		$curl = curl_init();
		curl_setopt_array($curl, array(
