...
add_action( 'wp_ajax_piotnetforms_mailchimp_merge_fields', 'piotnetforms_mailchimp_merge_fields' );
add_action( 'wp_ajax_nopriv_piotnetforms_mailchimp_merge_fields', 'piotnetforms_mailchimp_merge_fields' );

function piotnetforms_mailchimp_merge_fields(){
