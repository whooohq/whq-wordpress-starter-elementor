...
class Piotnetforms_License_Service {
    ...
    public static function login( $credential ) {
        ...
        if (defined( 'PIOTNETFORMS_VERSION' )) {
            $body['free_version'] = PIOTNETFORMS_VERSION;
        }
		...
		if ( current_user_can( 'edit_others_posts' ) ) {
            ...
            echo "<div class='piotnetforms-navigator piotnetforms-navigator-hidden'>
			    <div class='piotnetforms-navigator-header'>
					<i class='piotnetforms-navigator-toggle-all icon-angle-down'></i>
					<div class='piotnetforms-navigator-header-title' style='font-weight: 600;'>Navigator</div>
					<i class='piotnetforms-navigator-close fas fa-times'></i>
				</div>
...
?>
	<div class="wrap">
		...
		<div class="piotnetforms-wrap">
                ...
                <div class="piotnetforms-bottom__right">
                    <div class="piotnetforms-license">
                        ...
                        if (!$has_license) {
                            ...
                            if ($status === 'A') {
                                ?>
                                <div class="piotnetforms-license__description">License key: <?php echo $mask_license_key; ?><br>Type: <strong><?php echo $license['license_name']; ?></strong><br>Activated sites: <?php echo $license['activated_site_total']; ?><br>Total sites: <?php echo $license['unlimited_site'] ? "Unlimited" : $license['site_total']; ?> sites<br>Expired at: <?php echo $lifetime ? "Lifetime" : $expired_at_str; ?></div>
                                <?php
                            } else if ($status === 'E') {
                                ?>
                                <div class="piotnetforms-license__description">License key: <?php echo $mask_license_key; ?><br>Status: Your license has <strong>Expired</strong> at <?php echo $expired_at_str;?>.<br>Please renew your license today, to keep getting new updates and use full features.</div>
                                <?php
                            } else if ($status === 'D') {
                                ?>
                                <div class="piotnetforms-license__description">License key: <?php echo $mask_license_key; ?><br>Status: Your license is <strong>Disabled</strong>.<br>Please change to a valid license, to keep getting new updates and use full features.</div>
                                <?php
                            } else if ($status === 'I') {
                                ?>
                                ...
                                ?>
                                <div class="piotnetforms-license__description">License key: <?php echo $mask_license_key; ?><br>Status: Your license is <strong>Full</strong> (<?php echo $license['activated_site_total']; ?> of <?php echo $license['site_total']; ?> sites).<br>Please extend your license or deactivate other site, to keep getting new updates and use full features.</div>
                                <?php
                            } else if ($status === 'L') {
                                ?>
                                <div class="piotnetforms-license__description">License key: <?php echo $mask_license_key; ?><br>Status: Your license is <strong>Locked</strong> due has changed IP address.<br>Please remove and re-active your license.<br>If it still occurs, please connect to support.</div>
                                <?php
                            } else {
                                ?>
					...
					<div class="piotnetforms-license">
						<form method="post" action="options.php">
						    ...
						    <table class="form-table">
						        ...
						        <td><input type="text" name="piotnetforms-mollie-api-key" value="<?php echo $api_key; ?>" class="regular-text"/></td>
						        </tr>
						    </table>
						    <?php submit_button(__('Save Settings','piotnetforms')); ?>
						</form>
			...
			<div class="piotnetforms-bottom">
				<div class="piotnetforms-bottom__left">
					<h3><?php esc_html_e( 'Hubspots Integration', 'piotnetforms' ); ?></h3>
				</div>
				<div class="piotnetforms-bottom__right">
					<div class="piotnetforms-license">
						<form method="post" action="options.php">
							...
							<?php
								$api_key = esc_attr( get_option( 'piotnetforms-hubspot-api-key' ) );
							?>
							<table class="form-table">
								<tr valign="top">
								<th scope="row"><?php esc_html_e( 'API Key', 'piotnetforms' ); ?></th>
								<td><input type="text" name="piotnetforms-hubspot-api-key" value="<?php echo $api_key; ?>" class="regular-text"/></td>
								</tr>
							</table>
							<?php submit_button( __( 'Save Settings', 'piotnetforms' ) ); ?>
						</form>
					...
					<div class="piotnetforms-license">
						<form method="post" action="options.php">
							...
							<table class="form-table">
								...
								<td><input type="text" name="piotnetforms-addons-for-elementor-pro-sendinblue-api-key" value="<?php echo $sendinblue_api_key; ?>" class="regular-text"/></td>
								</tr>
							</table>
					...
					<div class="piotnetforms-license">
						<form method="post" action="options.php">
							...
							<table class="form-table">
								<tr valign="top">
								<th scope="row"><?php esc_html_e( 'API Key', 'piotnetforms' ); ?></th>
								<td><input type="text" name="piotnetforms-convertkit-api-key" value="<?php echo $convertkit_api_key; ?>" class="regular-text"/></td>
								</tr>
							</table>
							<?php submit_button( __( 'Save Settings', 'piotnetforms' ) ); ?>
						</form>
