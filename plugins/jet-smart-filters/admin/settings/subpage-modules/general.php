...
class Jet_Smart_Filters_Admin_Setting_Page_General extends Page_Module_Base {
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-smart-filters-general-settings'] = jet_smart_filters()->plugin_path( 'admin/templates/settings-templates/general-settings.php' );
