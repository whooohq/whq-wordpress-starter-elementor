...
class Jet_Smart_Filters_Admin_Setting_Page_URL_Structure extends Page_Module_Base {
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-smart-filters-url-structure-settings'] = jet_smart_filters()->plugin_path( 'admin/templates/settings-templates/url-structure-settings.php' );
