...
?>
<div class="jet-filter-items-moreless" data-less-items-count="<?php echo $less_items_count; ?>" data-more-text="<?php echo $more_text; ?>" data-less-text="<?php echo $less_text; ?>">
