...
?><a class="elementor-button elementor-size-md jet-download jet-download-icon-position-<?php echo $position; ?>" href="<?php echo jet_elements_download_handler()->get_download_link( $settings['download_file'], $settings['download_id_encryption'] ); ?>" <?php echo $rel; ?>><?php
