...
class VideoPlaylistHandler extends _baseTabs.default {
  ...
  handleFirstVideoActivation(isLazyLoad) {
    if (!isLazyLoad) {
      ...
      (_this$$element$ = this.$element[0]) === null || _this$$element$ === void 0 ? void 0 : _this$$element$.scrollIntoView(); // No need to use the observer since "lazy load is" off.
...
//# sourceMappingURL=video-playlist.4d89586f7ae0ae7b64a0.bundle.js.map