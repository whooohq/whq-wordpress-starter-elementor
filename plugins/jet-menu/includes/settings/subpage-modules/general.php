...
class General extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-menu-general-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'General Settings', 'jet-menu' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-menu-general-settings'] = jet_menu()->plugin_path( 'templates/admin/settings-templates/general-settings.php' );
