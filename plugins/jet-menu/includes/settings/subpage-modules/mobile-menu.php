...
class Mobile_Menu extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-menu-mobile-menu-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Mobile Render', 'jet-menu' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-menu-mobile-menu-settings'] = jet_menu()->plugin_path( 'templates/admin/settings-templates/mobile-menu-settings.php' );
