...
class Main_Menu extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'jet-menu-main-menu-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Main Menu', 'jet-menu' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['jet-menu-main-menu-settings'] = jet_menu()->plugin_path( 'templates/admin/settings-templates/main-menu-settings.php' );
